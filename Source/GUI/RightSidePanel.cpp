...
QGroupBox* RightSidePanel::createInitialConditionsGroup()
{
	...
	// Gravity
	{
		...
		gravity_label->setStyleSheet("QLabel { font-weight: bold; color: rgb(200, 200, 200);}");
	...
	// Initial Velocities
	{
		...
		initial_velocity_label->setStyleSheet("QLabel { font-weight: bold; color: rgb(200, 200, 200);}");
	...
	// Densities
	{
		...
		density_label_single->setStyleSheet("QLabel { font-weight: bold; color: rgb(200, 200, 200);}");
		...
		density_label_multi->setStyleSheet("QLabel { font-weight: bold; color: rgb(200, 200, 200);}");
	...
	// Initial temperature
	{
		...
		initial_temprature_label->setStyleSheet("QLabel { font-weight: bold; color: rgb(200, 200, 200);}");
